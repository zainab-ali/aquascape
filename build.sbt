...
lazy val core = crossProject(JVMPlatform, JSPlatform)
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      ("org.creativescala" %%% "doodle-core" % "0.24.0"),
  ...
  .jvmSettings(
    libraryDependencies ++= Seq(
      "org.creativescala" %% "doodle-java2d" % "0.24.0"
    )
  )
  .jsSettings(
    Test / fork := false,
    libraryDependencies += ("org.creativescala" %%% "doodle-svg" % "0.24.0")
      .exclude(
        "com.lihaoyi",
        "sourcecode_sjs1_3"
...
lazy val examples = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ("org.creativescala" %%% "doodle-svg" % "0.24.0")
        .exclude(
          "com.lihaoyi",
          "sourcecode_sjs1_3"
