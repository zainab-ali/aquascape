...
lazy val core = crossProject(JVMPlatform, JSPlatform)
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "org.creativescala" %%% "doodle-core" % "0.34.0",
  ...
  .jvmSettings(
    libraryDependencies ++= Seq(
      "org.creativescala" %% "doodle-java2d" % "0.34.0",
  ...
  .jsSettings(
    ...
    libraryDependencies += ("org.creativescala" %%% "doodle-svg" % "0.34.0")
      .exclude(
        "com.lihaoyi",
        "sourcecode_sjs1_3"
...
lazy val siteUtils = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ("org.creativescala" %%% "doodle-svg" % "0.34.0")
        .exclude(
          "com.lihaoyi",
          "sourcecode_sjs1_3"
